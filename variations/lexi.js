(function(){const{useState:l,useEffect:k,useRef:S}=React;if(typeof document<"u"&&!document.getElementById("lexi-interlocutor-styles")){const e=document.createElement("style");e.id="lexi-interlocutor-styles",e.textContent=`
    ...
    `,document.head.appendChild(e)}const z={idle:"assets/lexi-idle.webp",curious:"assets/lexi-curious.webp",excited:"assets/lexi-excited.webp",teaching:"assets/lexi-teaching.webp",sleeping:"assets/lexi-sleeping.webp"};function I({state:e,size:t=110}){const a=z[e]||z.idle;return React.createElement("div",{style:{position:"relative",width:t*1.4,height:t*1.15,flex:"0 0 auto",filter:"drop-shadow(0 8px 14px rgba(60,40,15,0.28)) drop-shadow(0 2px 4px rgba(60,40,15,0.18))"}},React.createElement("img",{src:a,alt:`Lexi ${e}`,style:{width:"100%",height:"auto",display:"block",pointerEvents:"none",userSelect:"none"},draggable:!1}))}function M({text:e,loading:t,action:a}){const[r,n]=l("");return k(()=>{if(!e){n("");return}let d=0,o=!1;n("");const u=()=>{o||(d=Math.min(d+2,e.length),n(e.slice(0,d)),d<e.length&&setTimeout(u,18))};return u(),()=>{o=!0}},[e]),!e&&!t?null:React.createElement("div",{style:{position:"relative",maxWidth:240,minHeight:30,marginBottom:10,padding:"10px 14px 11px",background:"#fbf6e8",borderRadius:14,border:"1px solid rgba(80,60,30,0.18)",boxShadow:"0 6px 16px -6px rgba(60,40,15,0.22), 0 2px 4px -1px rgba(60,40,15,0.12)",fontFamily:"'Newsreader','GT Sectra','Times New Roman',serif",fontSize:14,lineHeight:1.35,color:"#2a2418",fontStyle:"italic"}},t?React.createElement("span",{style:{opacity:.55}},"\xB7\xA0\xB7\xA0\xB7"):React.createElement("span",null,"\u201C",r,(r.length<(e||"").length,""),"\u201D"),a&&r.length===(e||"").length&&!t?React.createElement("div",{style:{marginTop:8,paddingTop:8,borderTop:"1px dashed rgba(80,60,30,0.20)",display:"flex",justifyContent:"flex-end"}},React.createElement("button",{onClick:a.onClick,style:{fontFamily:"'JetBrains Mono',ui-monospace,monospace",fontSize:10,letterSpacing:"0.14em",textTransform:"uppercase",color:"#5a4a2a",background:"transparent",border:"1px solid rgba(80,60,30,0.30)",borderRadius:6,padding:"5px 10px",cursor:"pointer",fontStyle:"normal"}},a.label)):null,React.createElement("svg",{width:"22",height:"14",viewBox:"0 0 22 14",style:{position:"absolute",bottom:-13,right:26}},React.createElement("path",{d:"M 2 0 L 18 0 L 11 13 Z",fill:"#fbf6e8",stroke:"rgba(80,60,30,0.18)",strokeWidth:"1"}),React.createElement("path",{d:"M 2 0 L 18 0",stroke:"#fbf6e8",strokeWidth:"2"})))}function R({activeTerm:e,onClose:t}){const[a,r]=l([]),[n,d]=l(""),[o,u]=l(!1),[b,g]=l(""),[h,v]=l(null),m=S(null);k(()=>{const i=x=>{x.key==="Escape"&&t()};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[t]),k(()=>{m.current?.scrollIntoView({behavior:"smooth",block:"end"})},[a,b]);async function y(i){i?.preventDefault();const x=n.trim();if(!x||o)return;const A={role:"user",content:x},c=[...a,A];r(c),d(""),u(!0),g(""),v(null);try{const p=await fetch("/api/ask-lexi",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({transcript:c,term:e?{id:e.id,label:e.label,fullName:e.fullName,def:e.def,clusters:e.clusters,refs:e.refs}:null})});if(!p.ok){if(p.status===401)throw new Error("Authentication required. Reload the page to re-prompt for the password.");const L=await p.text();throw new Error("HTTP "+p.status+": "+L.slice(0,200))}let f="";const s=p.body.getReader(),D=new TextDecoder;let E="";for(;;){const{done:L,value:O}=await s.read();if(L)break;E+=D.decode(O,{stream:!0});const B=E.split(`

`);E=B.pop();for(const j of B)for(const C of j.split(`
`)){if(!C.startsWith("data:"))continue;const N=C.slice(5).trim();if(!(!N||N==="[DONE]"))try{const w=JSON.parse(N);w.type==="content_block_delta"&&w.delta?.type==="text_delta"&&(f+=w.delta.text,g(f))}catch(w){console.warn("Lexi SSE parse error:",w,N)}}}r([...c,{role:"assistant",content:f}]),g("")}catch(p){v(p.message)}finally{u(!1)}}return React.createElement("div",{className:"lexi-overlay",onClick:t},React.createElement("div",{className:"lexi-lightbox",onClick:i=>i.stopPropagation()},React.createElement("button",{className:"lexi-close",onClick:t,"aria-label":"Close"},"\xD7"),React.createElement("div",{className:"lexi-stage"},React.createElement(I,{state:"teaching",size:140})),e&&React.createElement("div",{className:"lexi-context"},"On ",React.createElement("strong",null,e.label)),React.createElement("div",{className:"lexi-transcript"},a.length===0&&!o&&React.createElement("div",{style:{color:"#888",fontStyle:"italic",textAlign:"center",padding:"20px 0"}},e?`Ask Lexi about ${e.label}.`:"Ask Lexi about a term."),a.map((i,x)=>React.createElement("div",{key:x,className:"lexi-msg lexi-msg-"+i.role},i.content)),o&&b&&React.createElement("div",{className:"lexi-msg lexi-msg-assistant"},b,React.createElement("span",{className:"lexi-cursor"},"\u258C")),o&&!b&&React.createElement("div",{className:"lexi-thinking"},"\xB7\xA0\xB7\xA0\xB7"),h&&React.createElement("div",{className:"lexi-error"},h),React.createElement("div",{ref:m})),React.createElement("form",{className:"lexi-composer",onSubmit:y},React.createElement("textarea",{value:n,onChange:i=>d(i.target.value),onKeyDown:i=>{i.key==="Enter"&&!i.shiftKey&&(i.preventDefault(),y(i))},placeholder:e?'Ask Lexi about "'+e.label+'"\u2026':"Ask Lexi\u2026",disabled:o,rows:2,autoFocus:!0}),React.createElement("button",{type:"submit",disabled:o||!n.trim()},o?"\u2026":"Ask"))))}function P({state:e="idle",activeTerm:t=null,palette:a=null,customMessage:r=null,notFoundQuery:n=null}){const[d,o]=l(null),[u,b]=l(!1),[g,h]=l(!1),[v,m]=l(!1),y=S(null),i=S(null),x=e==="teaching"?130:108;return k(()=>{if(r){o(r);return}if(e==="curious"&&n){i.current!==n&&(i.current=n,h(!1));const s=n.length>24?n.slice(0,22)+"\u2026":n;o(g?`Off to hoover up \u201C${s}\u201D. Check back soon.`:`I don't have \u201C${s}\u201D yet.`);return}if(e!=="teaching"||!t){o({idle:null,curious:"Hmm, let me look\u2026",excited:"Found it!",sleeping:null,teaching:null}[e]||null);return}if(y.current===t.id)return;y.current=t.id;const c=(t.clusters||[]).map(s=>a?.[s]?.label).filter(Boolean).join(", "),p=["You are Lexi, the lexicographer mascot of an AI Terminology Atlas.","You are a small, warm, slightly bookish robot vacuum cleaner who hoovers up new AI terms from the web and curates them.",`A user has just opened the term: "${t.fullName||t.label}".`,`It belongs to clusters: ${c||"unspecified"}.`,t.def?`Definition snippet: "${String(t.def).slice(0,240)}"`:"","","Write ONE short sentence (max ~18 words) reacting to this term, in character.","Be specific to the term \u2014 never generic. Voice: warm, curious, a bit dry, occasionally playful.","Do NOT define the term. Do NOT explain it. React to it: a curated note, a connection, a why-it-matters, an opinion, an aside.",'Plain text. No quotes. No emoji. No leading "Ah," or "Well,".'].join(`
`);b(!0),o(null);let f=!1;return(async()=>{try{const s=await window.claude.complete(p);f||o((s||"").trim().replace(/^["']|["']$/g,""))}catch{f||o(`The term \u201C${t.label}\u201D is one I keep an eye on.`)}finally{f||b(!1)}})(),()=>{f=!0}},[e,t?.id,r,n,g]),React.createElement(React.Fragment,null,React.createElement("div",{style:{position:"absolute",bottom:24,right:28,zIndex:8,display:"flex",alignItems:"flex-end",gap:0,flexDirection:"column",pointerEvents:"none"}},React.createElement("div",{style:{pointerEvents:"auto",alignSelf:"flex-end",marginRight:18}},React.createElement(M,{text:d,loading:u,action:e==="curious"&&n&&!g?{label:"Hoover it up",onClick:()=>h(!0)}:null})),React.createElement("div",{className:"lexi-avatar-clickable",style:{pointerEvents:"auto"},onClick:()=>m(!0),title:"Ask Lexi a question",role:"button",tabIndex:0,onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),m(!0))}},React.createElement(I,{state:e,size:x}))),v&&React.createElement(R,{activeTerm:t,onClose:()=>m(!1)}))}window.Lexi=P,window.LexiAvatar=I})();
